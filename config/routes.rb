...
#      reservation_transactions GET    /reservations/:reservation_id/transactions(.:format)     transactions#index
#                               POST   /reservations/:reservation_id/transactions(.:format)     transactions#create
#   new_reservation_transaction GET    /reservations/:reservation_id/transactions/new(.:format) transactions#new
